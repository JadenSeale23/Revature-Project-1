...
public class AuthService {
    ...
    public UserDTO login(LoginDTO lDTO, HttpSession session){
        ...
        if(u== null){
            throw new IllegalArgumentException("No user found with given username/password combination!");
        }

        //If a user is found, login was successful
        ...
        return new UserDTO(u.getUserId(), u.getUsername(), u.getRole());
    }
